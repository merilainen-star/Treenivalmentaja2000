...
service to anyone else. These terms exist because the Oura developer portal requires a link to some;
they describe an application with one user rather than a product with customers.
...
**This app does not provide medical advice, diagnosis or treatment.** It displays numbers produced by
an Oura ring and schedules training sessions from a plan its user wrote or imported. It is not a
medical device, it has not been clinically validated, and nothing it shows should be used to make a
medical decision. Training carries a risk of injury. Consult a qualified professional about your own
health and training, and stop exercising if you feel unwell.

## 3. No warranty

The software is provided **"as is", without warranty of any kind**, express or implied, including but
not limited to the warranties of merchantability, fitness for a particular purpose and
non-infringement. It may contain defects, may lose or fail to record data, may schedule a reminder at
the wrong time, and may stop working entirely — for example if the Oura API changes.

## 4. Limitation of liability

To the fullest extent permitted by law, the author is not liable for any claim, damages or other
liability arising from the software or its use, including injury, lost data, or missed training.

## 5. Your Oura account

Connecting Oura requires the user to register their own application in Oura's developer portal and
to authorise it against their own Oura account. Use of the Oura service and API is governed by
